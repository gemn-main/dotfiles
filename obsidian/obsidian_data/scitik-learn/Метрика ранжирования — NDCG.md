NDCG расшифровывается как Normalized Discounted Cumulative Gain — нормализованный дисконтированный накопленный выигрыш. 
...
Технически это делают, деля релевантность на логарифм от позиции — чем дальше позиция, тем сильнее делитель, тем меньше вклад этого объекта в итоговую сумму. Запоминать формулу не нужно — важно уловить саму идею: **чем выше в списке полезный объект, тем больше он "весит" в итоговой оценке**.

### Normalized (нормализованный) — приводим к диапазону 0..1

DCG (Discounted Cumulative Gain) — это просто число, и само по себе оно не особо интерпретируемо: непонятно, это "хорошо" или "плохо" — 15 это много или мало?
